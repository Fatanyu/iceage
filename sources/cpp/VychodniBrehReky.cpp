...
Konstruktor
*/
IceAge::VychodniBrehReky::VychodniBrehReky(std::string novyNazev):Command(novyNazev) {
}

/**
Destruktor
*/
IceAge::VychodniBrehReky::~VychodniBrehReky() {
}

/**
Podedena metoda pridavajici algoritmus pro prozkoumani lokace VychodniBrehReky.
*/
void IceAge::VychodniBrehReky::prozkoumat(IceAge::Veverka* scrat, std::vector<IceAge::Beast*> vektorBeast, std::vector<IceAge::Humanoid*> vektorHumanoid, IceAge::Reka* reka) {
	std::cout << std::endl;
	std::cout << "Pomalu si prisel k rece. Jsi na druhe strane reky, u ktere si ztratil Supomuta." << std::endl;
	...
	while(cyklus2)/**< @brief Cyklus hlavnich moznosti prozkoumavani.*/
        {
            ...
            std::cout << "[" << index << "] Hledat orisek cichem" <<std::endl; index=0;
            std::cout << "Vyber akci:";
            ...
            switch(volba)
            {
                ...
                case '3':/**< @brief Moznost zautocit na nekoho.*/
                    ...
                    break;
                case '4':/**< @brief Moznost hledat Orisek Cichem*/
                    std::cout << std::endl;
                    std::cout << "Zapojil si svuj cich, orisek je smerem k jezeru!" << std::endl;
                    break;
                default:
                    break;
            }
